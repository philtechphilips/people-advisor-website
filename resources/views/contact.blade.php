...
@section('content')
    ...
    <section class="w-full md:px-24 px-5 md:py-24 pb-24">
        <div class="flex md:flex-row flex-col justify-between">
            ...
            <a href="tel:+234 913-413-9145" class=" md:w-[367px] flex items-center gap-3 mb-5">
                <img src="{{asset("images/call.svg")}}" alt="">
                <p class="font-bold underline">+234 913-413-9145</p>
            </a>
...
<form action="">
            <div class="md:w-[600px] bg-[#F7F7F7] md:p-16 p-8 rounded-[32px]">
                ...
                <p class="text-[#7c7c7c] font-medium mt-2">Have a specific question, request, or need assistance with professional tasks? Fill out the form below, and we'll get back to you as soon as possible</p>
                
                <div class="flex flex-col gap-1 mt-16">
                    <label for="name">Name</label>
                    <input type="text" class="font-medium bg-transparent outline-none px-3 py-1 border-b border-b-[#7C7C7C]" placeholder="Full name">
                </div>

                <div class="flex flex-col gap-1 mt-6">
                    <label for="name">Email</label>
                    <input type="email" class="font-medium bg-transparent outline-none px-3 py-1 border-b border-b-[#7C7C7C]" placeholder="you@company.com">
                </div>

                <div class="flex flex-col gap-1 mt-6">
                    <label for="name">Message</label>
                    <textarea rows="3"  class="font-medium bg-transparent outline-none px-3 py-1 border-b border-b-[#7C7C7C]" placeholder="Write a message..."></textarea>
                </div>
            </div>
           ...
           <div class="flex flex-wrap justify-between md:w-[600px]">
            ...
            <button type="submit" class="px-6 py-3 bg-[#075097] rounded-[32px] w-full text-white mt-12">Send message</button>
        </form>
        </div>
    </section>
@endsection()
